        ...
        synchronized (handle) {
            ...
            if (CUDA_VERSION == 8000 && (arch == 53 || arch == 60)) {
                ...
                cublasHgemm(new cublasContext(handle),
                        ...
                        new __half((ShortPointer)cAPointer.getDevicePointer()), lda,
                        new __half((ShortPointer)cBPointer.getDevicePointer()), ldb,
                        new __half().x((short)HalfIndexer.fromFloat(beta)),
                        new __half((ShortPointer)cCPointer.getDevicePointer()), ldc);
            } else {
